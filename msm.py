...
if __name__ == '__main__':
    ...
    add_server_parser = subparsers.add_parser('create', parents=[server_info_parser], help='Creates a server')
    ...
    add_server_parser.add_argument('-t', '--server-type', choices=list(ServerType), type=ServerType.from_string, default=ServerType.PAPER, help='The type of server to use when building a jar, defaults to paper')
    ...
    subparsers.add_parser('list', help='Lists the existing minecraft servers').set_defaults(func=list_servers)
